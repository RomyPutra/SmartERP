...
<form id="quickForm" novalidate>
   <div class="modal fade" id="modal-AddData" data-backdrop="static" 
      ...
      <div class="modal-dialog modal-dialog-centered">
         ...
         <div class="modal-body">
            <div class="form-group">
               ...
               <input name="SectionID" type="SectionID" class="form-control" id="SectionID" placeholder="Enter Section ID">
            </div>
            <div class="form-group">
               <label for="SectionName">Section Name</label>
               <input name="SectionName" type="SectionName" class="form-control" id="SectionName" placeholder="Enter Section Name">
            </div>
         </div>
         <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <!-- <button type="submit" id="my_button" class="btn btn-primary toastsDefaultSuccess">Save changes</button> -->
